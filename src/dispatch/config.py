...
DISPATCH_AUTHENTICATION_PROVIDER_PKCE_OPEN_ID_CONNECT_URL = config(
    "DISPATCH_AUTHENTICATION_PROVIDER_PKCE_OPEN_ID_CONNECT_URL", default=""
)
DISPATCH_AUTHENTICATION_PROVIDER_PKCE_CLIENT_ID = config(
    "DISPATCH_AUTHENTICATION_PROVIDER_PKCE_CLIENT_ID", default=""
)
DISPATCH_AUTHENTICATION_PROVIDER_USE_ID_TOKEN = config(
