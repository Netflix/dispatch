...
DATABASE_ENGINE_CONNECT_TIMEOUT = config("DATABASE_ENGINE_CONNECT_TIMEOUT", cast=int, default=10)
...
DATABASE_ENGINE_STATEMENT_TIMEOUT = config(
    "DATABASE_ENGINE_STATEMENT_TIMEOUT", cast=int, default=60
)
