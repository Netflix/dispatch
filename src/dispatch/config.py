...
INCIDENT_STORAGE_INCIDENT_REPORT_FILE_ID = config("INCIDENT_STORAGE_INCIDENT_REPORT_FILE_ID")
...
INCIDENT_RESOURCE_INCIDENT_REPORT_DOCUMENT = config(
    "INCIDENT_RESOURCE_INCIDENT_REPORT_DOCUMENT", default="google-docs-incident-report-document"
)
