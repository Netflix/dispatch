...
INCIDENT_STORAGE_INCIDENT_UPDATE_FILE_ID = config("INCIDENT_STORAGE_INCIDENT_UPDATE_FILE_ID")
...
INCIDENT_RESOURCE_INCIDENT_UPDATE_DOCUMENT = config(
    "INCIDENT_RESOURCE_INCIDENT_UPDATE_DOCUMENT", default="google-docs-incident-update-document"
)
