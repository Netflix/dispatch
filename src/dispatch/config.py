...
DISPATCH_HELP_EMAIL = os.getenv("DISPATCH_HELP_EMAIL")
DISPATCH_HELP_SLACK_CHANNEL = os.getenv("DISPATCH_HELP_SLACK_CHANNEL")
...
# incident resources
INCIDENT_STORAGE_ARCHIVAL_FOLDER_ID = os.getenv("INCIDENT_STORAGE_ARCHIVAL_FOLDER_ID")
INCIDENT_STORAGE_INCIDENT_REVIEW_FILE_ID = os.getenv("INCIDENT_STORAGE_INCIDENT_REVIEW_FILE_ID")
INCIDENT_DOCUMENT_INVESTIGATION_SHEET_ID = os.getenv("INCIDENT_DOCUMENT_INVESTIGATION_SHEET_ID")
INCIDENT_FAQ_DOCUMENT_ID = os.getenv("INCIDENT_FAQ_DOCUMENT_ID")
