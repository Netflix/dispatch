...
def upgrade():
    ...
    try:
        ...
        log.debug("Skipping migration of assignee and creator emails to participants...")
    else:
        ...
        for incident_id, creator, assignees, id in tasks:
            ...
            # fetch creator email
            creator = (
                session.query(IndividualContact).filter(IndividualContact.name == creator).first()
            )
