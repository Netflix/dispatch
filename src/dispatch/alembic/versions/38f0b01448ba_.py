...
def upgrade():
    ...
    bind = op.get_bind()
    bind.execute("ALTER INDEX status_report_pkey RENAME TO report_pkey")
    bind.execute(
        "ALTER TABLE report RENAME CONSTRAINT status_report_incident_id_fkey TO report_incident_id_fkey"
    )
    bind.execute(
        "ALTER TABLE report RENAME CONSTRAINT status_report_participant_id_fkey TO report_participant_id_fkey"
    )
    bind.execute("ALTER SEQUENCE status_report_id_seq RENAME TO report_id_seq")
