...
def upgrade():
    ...
    bind.execute(
        "ALTER TABLE IF EXISTS report RENAME CONSTRAINT status_report_incident_id_fkey TO report_incident_id_fkey"
    )
    bind.execute(
        "ALTER TABLE IF EXISTS report RENAME CONSTRAINT status_report_participant_id_fkey TO report_participant_id_fkey"
    )
