...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"], ["document.id"], name="workflow_instance_artifacts_document_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["workflow_instance_id"],
            ["workflow_instance.id"],
            name="workflow_instance_artifacts_workflow_instance_id_fkey",
        ),
        sa.PrimaryKeyConstraint(
            "document_id", "workflow_instance_id", name="workflow_instance_artifacts_pkey"
        ),
    )
