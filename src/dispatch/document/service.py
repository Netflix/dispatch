...
def get_overdue_evergreen_documents(*, db_session, project_id: int) -> list[Document]:
...
def get_all(*, db_session) -> list[Document]:
...
def delete(*, db_session, document_id: int) -> None:
    """Deletes a document."""
