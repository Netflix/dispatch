...
def upgrade():
    ...
    op.add_column(
        "tag_type",
        sa.Column(
            "discoverable_case", sa.Boolean(), nullable=True, server_default="t", default=True
        ),
    )
    op.add_column(
        "tag_type",
        sa.Column(
            "discoverable_incident", sa.Boolean(), nullable=True, server_default="t", default=True
        ),
    )
    op.add_column(
        "tag_type",
        sa.Column(
            "discoverable_query", sa.Boolean(), nullable=True, server_default="t", default=True
        ),
    )
    op.add_column(
        "tag_type",
        sa.Column(
            "discoverable_signal", sa.Boolean(), nullable=True, server_default="t", default=True
        ),
    )
    op.add_column(
        "tag_type",
        sa.Column(
            "discoverable_source", sa.Boolean(), nullable=True, server_default="t", default=True
        ),
    )
