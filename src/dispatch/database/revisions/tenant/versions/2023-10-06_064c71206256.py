...
def upgrade():
    ...
    op.alter_column("service_feedback", "hours", existing_type=sa.Integer(), type_=sa.Numeric(), nullable=True)
...
def downgrade():
    ...
    op.alter_column("service_feedback", "hours", existing_type=sa.Numeric(), type_=sa.Integer(), nullable=True)
    # ### end Alembic commands ###
