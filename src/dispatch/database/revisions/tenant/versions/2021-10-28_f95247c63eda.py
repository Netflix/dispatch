...
def upgrade():
    ...
    op.add_column("project", sa.Column("buisness_year_hours", sa.Integer(), nullable=True))
    ...
    for project in projects:
        ...
        project.buisness_year_hours = config("BUSINESS_HOURS_YEAR", cast=int, default="2080")
...
def downgrade():
    ...
    op.drop_column("project", "buisness_year_hours")
