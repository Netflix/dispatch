  ...
  <div>
    <v-menu v-model="menu" bottom right transition="scale-transition" origin="top left">
      <template v-slot:activator="{ on }">
        <v-chip pill small v-on="on" v-if="participant.individual || participant.individual.length">
      ...
      <v-card width="300">
        <v-list dark>
          <v-list-item v-if="participant.individual || participant.individual.length">
