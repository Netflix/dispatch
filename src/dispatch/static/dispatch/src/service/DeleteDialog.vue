    ...
    <v-card>
      ...
      <v-card-text>
        <v-container grid-list-md>
          <v-layout wrap> Are you sure you would like to delete this service? </v-layout>
        </v-container>
      </v-card-text>
      <v-card-actions>
        <v-spacer />
...
export default {
  name: "ServiceDeleteDialog",
  data() {
    return {}
  },
  computed: {
    ...mapFields("service", ["dialogs.showRemove"]),
  },

  methods: {
    ...mapActions("service", ["remove", "closeRemove"]),
  },
}
</script>
