...
import DeleteDialog from "@/case_cost_type/DeleteDialog.vue"
import NewEditSheet from "@/case_cost_type/NewEditSheet.vue"

export default {
  name: "CaseCostTypeTable",
  ...
  methods: {
    ...mapActions("case_cost_type", ["getAll", "createEditShow", "removeShow"]),
  },
}
</script>
