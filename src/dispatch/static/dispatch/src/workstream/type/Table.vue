    ...
    <v-row no-gutters>
      <v-col>
        <v-alert dismissible icon="mdi-school" prominent text type="info">
          Workstreams enable responders to comparmentalize different lines of response work.
        </v-alert>
      </v-col>
    </v-row>
...
import NewEditSheet from "@/Workstream/type/NewEditSheet.vue"
...
export default {
  ...
  data() {
    return {
      headers: [
        ...
        { text: "Document Template", value: "document_template.name", sortable: false },
  ...
  methods: {
    ...mapActions("workstream_type", ["getAll", "createEditShow", "removeShow"]),
  },
}
</script>
