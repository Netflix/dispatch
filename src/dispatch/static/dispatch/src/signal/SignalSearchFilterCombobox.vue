    ...
    <v-row no-gutter>
      ...
      >
        ...
        <template slot="append-outer">
          <signal-search-filter-create-dialog v-model="createdFilter" />
        </template>
      </v-combobox>
    </v-row>
  </v-container>
...
import SignalSearchFilterCreateDialog from "@/signal/SignalSearchFilterCreateDialog.vue"

export default {
  name: "SignalSearchFilterCombobox",
  props: {
    value: {
      type: Array,
      default: function () {
  ...
  components: { SignalSearchFilterCreateDialog },
