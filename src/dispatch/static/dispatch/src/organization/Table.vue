...
import DeleteDialog from "@/organization/DeleteDialog.vue"
import NewEditSheet from "@/organization/NewEditSheet.vue"
export default {
  ...
  methods: {
    ...mapActions("organization", ["getAll", "createEditShow", "removeShow"])
  }
}
</script>
