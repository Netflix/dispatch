...
SLACK_DEPARTMENT_PROFILE_ID = config("SLACK_DEPARTMENT_PROFILE_ID", default="")
SLACK_TEAM_PROFILE_ID = config("SLACK_TEAM_PROFILE_ID", default="")
SLACK_WEBLINK_PROFILE_ID = config("SLACK_WEBLINK_PROFILE_ID", default="")
