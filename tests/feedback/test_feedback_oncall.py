    ...
    feedback_in = ServiceFeedbackUpdate(
        ...
        project=ProjectRead(
            ...
            weekly_report_notification_id=getattr(
                service_feedback.project, "weekly_report_notification_id", None
            ),
            ...
            storage_use_folder_one_as_primary=getattr(
                service_feedback.project, "storage_use_folder_one_as_primary", True
            ),
            ...
            select_commander_visibility=getattr(
                service_feedback.project, "select_commander_visibility", True
            ),
            report_incident_instructions=getattr(
                service_feedback.project, "report_incident_instructions", None
            ),
            report_incident_title_hint=getattr(
                service_feedback.project, "report_incident_title_hint", None
            ),
            report_incident_description_hint=getattr(
                service_feedback.project, "report_incident_description_hint", None
            ),
            snooze_extension_oncall_service=getattr(
                service_feedback.project, "snooze_extension_oncall_service", None
            ),
        ),
